<%-- 
    Document   : index
    Created on : 22-sep-2020, 15:46:10
    Author     : froil
--%>
    ...
    <div class="page-container">
        ...
        <div class="sidebar-menu">
            <div class="sidebar-header">
                ...
                <br>
                <h6 class="text-center" style="color: aliceblue"><i class="fa fa-user"></i> <strong>FroilanT</strong></h6>
            </div>
            <div class="main-menu">
                            ...
                            <div class="card-body">
                                ...
                                <form id="FrmCategoria">
                                    <div class="row mt-3">
                                        ...
                                        <button type="button" id="btnNCategoria" class="btn-btn-primary btn-xs"><i class="fa fa-plus-square" aria-hidden="true"></i></button>
                                        </div>
                                    </div>
        ...
        <footer>
            <div class="footer-area">
                <p>© Copyright 2020 <a href="https://colorlib.com/wp/">Froilan T</a>.</p>
            </div>
        </footer>
        <!-- footer area end-->
    </div>
